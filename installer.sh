...
log "Starting Jmod installer."

CROSH="/usr/bin/crosh"
MURK_DIR="/mnt/stateful_partition/murkmod"
JMOD_URL="https://raw.githubusercontent.com/Jmoney46/Jmod/main/utilities/Jmod.sh"
...
curl -fsSLo "$CROSH" "$JMOD_URL" || error "Failed to download MushM."
...
echo -e "${YELLOW}Made by Stardestroyer12 & StarkMist111960. JMOD Edited by Jmoney46.${RESET}" 
sleep 2
